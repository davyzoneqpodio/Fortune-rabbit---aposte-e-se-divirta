...
Versão 1.2.1 do Fortune Rabbit: jogo individual com créditos fictícios, ranking global e salas competitivas para até 7 amigos.
...
Cada jogador tem uma máquina independente. Os giros não são compartilhados. O que é compartilhado é o placar: lucro atual, saldo, número de rodadas e atividade. O placar é atualizado por WebSocket, com polling de 5 segundos como fallback. O lucro é calculado pelo saldo líquido da sessão (`saldo final - 1.000`). Ao finalizar uma partida de sala, o jogador vê uma tela final com o resumo e o ranking da sala naquele momento.
